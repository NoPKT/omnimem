...
- CI/docs tooling: add `scripts/check_docs_i18n.py` as a CI gate and `scripts/report_webui_i18n_coverage.py` as a coverage report step for WebUI localization drift monitoring.
