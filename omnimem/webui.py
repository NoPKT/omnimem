  ...
  <script>
    const I18N = {
      ...
      zh: {
        ...
        project_title: '项目集成', project_path: '项目路径', project_id: '项目 ID',
        btn_browse_project: '浏览目录', btn_use_cwd: '使用服务端当前目录',
        browser_title: '目录浏览器', btn_browser_up: '上一级', btn_browser_select: '选择此目录', btn_browser_close: '关闭',
        btn_project_attach: '接入项目并安装代理规则', btn_project_detach: '解除项目接入',
        project_list_title: '已接入项目（本地）', btn_projects_reload: '刷新项目列表',
        project_hint: '接入会创建 .omnimem 文件，并向 AGENTS.md / CLAUDE.md / .cursorrules 注入托管记忆协议块。',
        cfg_saved: '配置已保存', cfg_failed: '保存失败',
        project_attach_ok: '项目接入成功', project_detach_ok: '项目已解除接入', project_failed: '项目操作失败',
      ...
      ja: {
        ...
        subtitle_simple: 'シンプルモード：状態と操作 / インサイト / メモリ',
        tab_status: '状態と操作', tab_insights: 'インサイト', tab_config: '設定', tab_project: 'プロジェクト連携', tab_memory: 'メモリ',
        system_status: 'システム状態', actions: '操作',
        insights_title: 'レイヤー化メモリマップ', insights_hint: '知識がどの層に分布しているかを素早く把握します。層をクリックすると Memory タブを絞り込みます。',
        ins_kinds: '種類', ins_activity: 'アクティビティ (14日)', ins_govern: 'ガバナンス', ins_govern_hint: '安定した知識を上位層へ、変動が大きく再利用の少ない項目を下位層へ調整します。',
        ins_tags: '上位タグ', ins_checkpoints: '最近のチェックポイント', ins_timeline: 'セッションタイムライン', ins_timeline_hint: 'ターンとチェックポイントをセッション単位で表示します。項目をクリックすると詳細を開きます。',
        mem_project_filter: 'プロジェクト ID フィルタ', btn_mem_reload: '再読み込み', btn_reload: '再読み込み', btn_advanced: '詳細',
        ...
        project_title: 'プロジェクト連携', project_path: 'プロジェクトパス', project_id: 'プロジェクト ID',
        btn_browse_project: 'ディレクトリ参照', btn_use_cwd: 'サーバー CWD を使用',
        browser_title: 'ディレクトリブラウザ', btn_browser_up: '上へ', btn_browser_select: 'このディレクトリを選択', btn_browser_close: '閉じる',
        btn_project_attach: 'プロジェクト接続 + エージェント規約を導入', btn_project_detach: 'プロジェクト切断',
        project_list_title: '接続済みプロジェクト（ローカル）', btn_projects_reload: 'プロジェクト再読込',
        project_hint: '.omnimem を作成し、AGENTS.md / CLAUDE.md / .cursorrules に管理メモリ規約ブロックを挿入します。',
        th_actions: '操作', th_project: 'プロジェクト',
      ...
      de: {
        ...
        subtitle_simple: 'Einfachmodus: Status & Aktionen / Insights / Speicher',
        tab_status: 'Status & Aktionen', tab_insights: 'Insights', tab_config: 'Konfiguration', tab_project: 'Projektintegration', tab_memory: 'Speicher',
        system_status: 'Systemstatus', actions: 'Aktionen',
        insights_title: 'Geschichtete Speicherkarte', insights_hint: 'Schneller Überblick über die Verteilung deines Wissens. Klicke auf eine Ebene, um den Memory-Tab zu filtern.',
        ins_kinds: 'Typen', ins_activity: 'Aktivität (14 Tage)', ins_govern: 'Governance', ins_govern_hint: 'Stabiles Wissen nach oben fördern; volatile, selten wiederverwendete Einträge absenken.',
        ins_tags: 'Top-Tags', ins_checkpoints: 'Letzte Checkpoints', ins_timeline: 'Sitzungs-Timeline', ins_timeline_hint: 'Turns und Checkpoints nach Sitzung gruppiert. Klicke auf einen Eintrag für Details.',
        mem_project_filter: 'Projekt-ID-Filter', btn_mem_reload: 'Neu laden', btn_reload: 'Neu laden', btn_advanced: 'Erweitert',
        ...
        project_title: 'Projektintegration', project_path: 'Projektpfad', project_id: 'Projekt-ID',
        btn_browse_project: 'Verzeichnis wählen', btn_use_cwd: 'Server-CWD verwenden',
        browser_title: 'Verzeichnisbrowser', btn_browser_up: 'Nach oben', btn_browser_select: 'Dieses Verzeichnis wählen', btn_browser_close: 'Schließen',
        btn_project_attach: 'Projekt anbinden + Agent-Regeln installieren', btn_project_detach: 'Projekt trennen',
        project_list_title: 'Verbundene Projekte (lokal)', btn_projects_reload: 'Projekte neu laden',
        project_hint: 'Beim Anbinden werden .omnimem-Dateien erstellt und verwaltete Speicherprotokoll-Blöcke in AGENTS.md / CLAUDE.md / .cursorrules eingefügt.',
        th_actions: 'Aktionen', th_project: 'Projekt',
      ...
      fr: {
        ...
        subtitle_simple: 'Mode simple : État et actions / Insights / Mémoire',
        tab_status: 'État et actions', tab_insights: 'Insights', tab_config: 'Configuration', tab_project: 'Intégration projet', tab_memory: 'Mémoire',
        system_status: 'État du système', actions: 'Actions',
        insights_title: 'Carte mémoire par couches', insights_hint: 'Vue rapide de la répartition de vos connaissances. Cliquez une couche pour filtrer l’onglet Memory.',
        ins_kinds: 'Types', ins_activity: 'Activité (14 jours)', ins_govern: 'Gouvernance', ins_govern_hint: 'Promouvoir les connaissances stables, rétrograder les éléments volatils peu réutilisés.',
        ins_tags: 'Tags principaux', ins_checkpoints: 'Checkpoints récents', ins_timeline: 'Chronologie de session', ins_timeline_hint: 'Tours et checkpoints groupés par session. Cliquez un élément pour les détails.',
        mem_project_filter: 'Filtre ID projet', btn_mem_reload: 'Recharger', btn_reload: 'Recharger', btn_advanced: 'Avancé',
        ...
        project_title: 'Intégration projet', project_path: 'Chemin du projet', project_id: 'ID projet',
        btn_browse_project: 'Parcourir le dossier', btn_use_cwd: 'Utiliser le CWD du serveur',
        browser_title: 'Navigateur de dossiers', btn_browser_up: 'Monter', btn_browser_select: 'Choisir ce dossier', btn_browser_close: 'Fermer',
        btn_project_attach: 'Attacher le projet + installer les règles agent', btn_project_detach: 'Détacher le projet',
        project_list_title: 'Projets attachés (local)', btn_projects_reload: 'Recharger les projets',
        project_hint: "L'attache crée des fichiers .omnimem et injecte des blocs de protocole mémoire gérés dans AGENTS.md / CLAUDE.md / .cursorrules.",
        th_actions: 'Actions', th_project: 'Projet',
      ...
      ru: {
        ...
        subtitle_simple: 'Простой режим: статус и действия / инсайты / память',
        tab_status: 'Статус и действия', tab_insights: 'Инсайты', tab_config: 'Конфигурация', tab_project: 'Интеграция проекта', tab_memory: 'Память',
        system_status: 'Состояние системы', actions: 'Действия',
        insights_title: 'Карта памяти по слоям', insights_hint: 'Быстрый обзор распределения знаний по слоям. Нажмите слой, чтобы отфильтровать вкладку Memory.',
        ins_kinds: 'Типы', ins_activity: 'Активность (14 дней)', ins_govern: 'Управление', ins_govern_hint: 'Повышайте стабильные знания, понижайте нестабильные и редко переиспользуемые элементы.',
        ins_tags: 'Топ тегов', ins_checkpoints: 'Недавние checkpoints', ins_timeline: 'Лента сессии', ins_timeline_hint: 'Turns и checkpoints, сгруппированные по сессии. Нажмите элемент для деталей.',
        mem_project_filter: 'Фильтр ID проекта', btn_mem_reload: 'Обновить', btn_reload: 'Обновить', btn_advanced: 'Расширенный',
        ...
        project_title: 'Интеграция проекта', project_path: 'Путь проекта', project_id: 'ID проекта',
        btn_browse_project: 'Выбрать каталог', btn_use_cwd: 'Использовать CWD сервера',
        browser_title: 'Браузер каталогов', btn_browser_up: 'Вверх', btn_browser_select: 'Выбрать этот каталог', btn_browser_close: 'Закрыть',
        btn_project_attach: 'Подключить проект + установить правила агента', btn_project_detach: 'Отключить проект',
        project_list_title: 'Подключённые проекты (локально)', btn_projects_reload: 'Обновить проекты',
        project_hint: 'Подключение создаст .omnimem и добавит блоки управляемого протокола памяти в AGENTS.md / CLAUDE.md / .cursorrules.',
        th_actions: 'Действия', th_project: 'Проект',
      ...
      it: {
        ...
        subtitle_simple: 'Modalità semplice: stato e azioni / insight / memoria',
        tab_status: 'Stato e azioni', tab_insights: 'Insight', tab_config: 'Configurazione', tab_project: 'Integrazione progetto', tab_memory: 'Memoria',
        system_status: 'Stato sistema', actions: 'Azioni',
        insights_title: 'Mappa memoria a livelli', insights_hint: 'Vista rapida di come la conoscenza è distribuita nei livelli. Clicca un livello per filtrare la scheda Memory.',
        ins_kinds: 'Tipi', ins_activity: 'Attività (14 giorni)', ins_govern: 'Governance', ins_govern_hint: 'Promuovi la conoscenza stabile; retrocedi elementi volatili e poco riusati.',
        ins_tags: 'Tag principali', ins_checkpoints: 'Checkpoint recenti', ins_timeline: 'Timeline sessione', ins_timeline_hint: 'Turni e checkpoint raggruppati per sessione. Clicca un elemento per i dettagli.',
        mem_project_filter: 'Filtro ID progetto', btn_mem_reload: 'Ricarica', btn_reload: 'Ricarica', btn_advanced: 'Avanzato',
        ...
        project_title: 'Integrazione progetto', project_path: 'Percorso progetto', project_id: 'ID progetto',
        btn_browse_project: 'Sfoglia directory', btn_use_cwd: 'Usa CWD del server',
        browser_title: 'Browser directory', btn_browser_up: 'Su', btn_browser_select: 'Seleziona questa directory', btn_browser_close: 'Chiudi',
        btn_project_attach: 'Collega progetto + installa regole agente', btn_project_detach: 'Scollega progetto',
        project_list_title: 'Progetti collegati (locali)', btn_projects_reload: 'Ricarica progetti',
        project_hint: 'Il collegamento crea file .omnimem e inserisce blocchi protocollo memoria gestita in AGENTS.md / CLAUDE.md / .cursorrules.',
        th_actions: 'Azioni', th_project: 'Progetto',
      ...
      ko: {
        ...
        subtitle_simple: '간단 모드: 상태/작업 · 인사이트 · 메모리',
        tab_status: '상태/작업', tab_insights: '인사이트', tab_config: '설정', tab_project: '프로젝트 통합', tab_memory: '메모리',
        system_status: '시스템 상태', actions: '작업',
        insights_title: '레이어 메모리 맵', insights_hint: '지식이 레이어별로 어떻게 분포하는지 빠르게 확인합니다. 레이어를 클릭하면 Memory 탭이 필터링됩니다.',
        ins_kinds: '유형', ins_activity: '활동 (14일)', ins_govern: '거버넌스', ins_govern_hint: '안정적인 지식은 상향, 변동이 크고 재사용이 낮은 항목은 하향 조정합니다.',
        ins_tags: '상위 태그', ins_checkpoints: '최근 체크포인트', ins_timeline: '세션 타임라인', ins_timeline_hint: '턴과 체크포인트를 세션별로 묶어 표시합니다. 항목을 클릭하면 상세를 엽니다.',
        mem_project_filter: '프로젝트 ID 필터', btn_mem_reload: '새로고침', btn_reload: '새로고침', btn_advanced: '고급',
        ...
        project_title: '프로젝트 통합', project_path: '프로젝트 경로', project_id: '프로젝트 ID',
        btn_browse_project: '디렉터리 찾아보기', btn_use_cwd: '서버 CWD 사용',
        browser_title: '디렉터리 브라우저', btn_browser_up: '상위로', btn_browser_select: '이 디렉터리 선택', btn_browser_close: '닫기',
        btn_project_attach: '프로젝트 연결 + 에이전트 규칙 설치', btn_project_detach: '프로젝트 연결 해제',
        project_list_title: '연결된 프로젝트 (로컬)', btn_projects_reload: '프로젝트 새로고침',
        project_hint: '연결 시 .omnimem 파일을 만들고 AGENTS.md / CLAUDE.md / .cursorrules에 관리형 메모리 프로토콜 블록을 주입합니다.',
        th_actions: '작업', th_project: '프로젝트',
    ...
    const I18N_LITERALS = {
      zh: {
        ...
        'Layer Board': '层级看板',
        'Memory Quality (Week)': '记忆质量（周）',
        'Sessions Console': '会话控制台',
        'Maintenance': '维护',
        'Governance Log': '治理日志',
        'Event Payload': '事件载荷',
        'Signals': '信号',
        ...
        'Session ID Filter': '会话 ID 过滤',
        'Thresholds': '阈值',
        'Promote to long (instant/short)': '提升到 long（instant/short）',
        'Demote to short (long)': '降级到 short（long）',
        ...
        'reuse ≤': 'reuse ≤',
        'Apply': '应用',
        'Apply Recommended': '应用推荐值',
        'Reload Sessions': '刷新会话',
        'Clear Active Session': '清除当前会话',
        'Archive Active Session': '归档当前会话',
        'Archive Options': '归档选项',
        'from layers': '来源层',
        'limit': '上限',
        'to layer': '目标层',
        'Session': '会话',
        ...
        '(any)': '（任意）',
        '(no repos)': '（无仓库）',
        '(click Refresh Repo List)': '（点击刷新仓库列表）',
        'kind': '类别',
        'tag': '标签',
        'since(days)': '起始（天）',
        'dedup': '去重',
        ...
        'Edit': '编辑',
        'Save': '保存',
        'Undo Last Move': '撤销上次移动',
        'Explain': '解释',
        'Preview Rollback': '预览回滚',
        'Rollback To Time': '回滚到时间点',
        'workset name': '工作集名称',
        'session_id': '会话ID',
        '(optional) FTS query': '（可选）FTS 查询',
        'e.g. auto:distill': '例如 auto:distill',
        'type APPLY if required': '如需执行请输入 APPLY',
        'template name': '模板名称',
        'type to filter (summary/type/id/project/session)': '输入过滤词（摘要/类型/ID/项目/会话）',
      },
      ja: {
        'Health Check': 'ヘルスチェック', 'Getting Started': 'はじめに', 'Layer Board': 'レイヤーボード',
        'Session ID Filter': 'セッション ID フィルタ', 'Session': 'セッション', 'Project': 'プロジェクト',
        'Actions': '操作', 'Close': '閉じる', 'Edit': '編集', 'Save': '保存', 'Cancel': 'キャンセル',
      },
      de: {
        'Health Check': 'Gesundheitscheck', 'Getting Started': 'Erste Schritte', 'Layer Board': 'Layer-Board',
        'Session ID Filter': 'Session-ID-Filter', 'Session': 'Session', 'Project': 'Projekt',
        'Actions': 'Aktionen', 'Close': 'Schließen', 'Edit': 'Bearbeiten', 'Save': 'Speichern', 'Cancel': 'Abbrechen',
      },
      fr: {
        'Health Check': 'Vérification santé', 'Getting Started': 'Prise en main', 'Layer Board': 'Tableau des couches',
        'Session ID Filter': 'Filtre Session ID', 'Session': 'Session', 'Project': 'Projet',
        'Actions': 'Actions', 'Close': 'Fermer', 'Edit': 'Modifier', 'Save': 'Enregistrer', 'Cancel': 'Annuler',
      },
      ru: {
        'Health Check': 'Проверка здоровья', 'Getting Started': 'Быстрый старт', 'Layer Board': 'Доска слоёв',
        'Session ID Filter': 'Фильтр Session ID', 'Session': 'Сессия', 'Project': 'Проект',
        'Actions': 'Действия', 'Close': 'Закрыть', 'Edit': 'Редактировать', 'Save': 'Сохранить', 'Cancel': 'Отмена',
      },
      it: {
        'Health Check': 'Controllo salute', 'Getting Started': 'Per iniziare', 'Layer Board': 'Board dei layer',
        'Session ID Filter': 'Filtro Session ID', 'Session': 'Sessione', 'Project': 'Progetto',
        'Actions': 'Azioni', 'Close': 'Chiudi', 'Edit': 'Modifica', 'Save': 'Salva', 'Cancel': 'Annulla',
      },
      ko: {
        'Health Check': '헬스 체크', 'Getting Started': '시작 가이드', 'Layer Board': '레이어 보드',
        'Session ID Filter': '세션 ID 필터', 'Session': '세션', 'Project': '프로젝트',
        'Actions': '작업', 'Close': '닫기', 'Edit': '편집', 'Save': '저장', 'Cancel': '취소',
      },
    };
